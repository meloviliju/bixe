export const CORPUS = [
    ...
    },
    {
        ...
        "directJa": "一つか二つの時、この人は、姉が読んでいる本を見た。",
    ...
    },
    {
        ...
        "directJa": "二人の人がこれをする。セットカイクにおいては、人は駒を動かし、役を作ろうとする。",
    ...
    },
    {
        ...
        "directJa": "一人の人が駒を動かしたのち、もう一人の人が駒を動かす。何度もこれをやる。",
    ...
    },
    {
        ...
        "directJa": "駒とは、動く小さい木である。役とは、点数を持つ良い駒の集まりである。",
    ...
    },
    {
        ...
        "directJa": "どのような理由によってアイル共和国はここで統一するのか？",
    ...
    },
    {
        ...
        "directJa": "今、多くのルールがあって人々も役場もよくない状況に至っている。",
    ...
    },
    {
        ...
        "directJa": "ここにアイル共和国がこれを統一し、人々も役場もよい思いをする。",
    ...
    },
    {
        ...
        "directJa": "皆、これ(=統一されたルール)をしよう(=遊ぼう)、そしてきっと皆これをするだろう。",
        "ja": "皆人がこれをすることを期待する。",
        "en": ""
    },
    {
    ...
    },
    {
        ...
        "directJa": "【筆兵無傾】書記官と兵士/カカウクムナウン（緯武経文）",
    ...
    },
    {
        ...
        "directJa": "【馬弓兵】ヴェフィスの兵士/マウンカカウク（馬と弓を操るヴェフィス兵）",
    ...
    },
    {
        ...
        "directJa": "【行行】行く・行く/モクモク（移動しようとする）",
        "ja": "行行 トゥデトゥデ/モクモク",
        "en": ""
    },
    {
    ...
    },
    {
        ...
        "directJa": "【闇戦之集】光がない/ケトカイタダト（行き詰まった軍）",
    ...
    },
    {
        ...
        "directJa": "そのようなとき、あなたは【王】を使うことができ、その駒(=【王】)はあなたがもっていないあの駒(=前文で言及された、役を完成させるために必要な駒)を演じることができる。",
    ...
    },
    {
        ...
        "directJa": "演じることによって異なる色に至らせることはできない。",
    ...
    },
    {
        ...
        "directJa": "【撃皇】タム神を踏み越える/クタン（タム神を攻撃する）",
        "ja": "撃皇 セモコイトタン/クタン",
        "en": ""
    },
    {
    ...
    },
    {
        ...
        "directJa": "【皇再来】再来/タントゥモク（タム神が再び行く）",
        "ja": "皇再来 マクキレ/タントゥモク",
        "en": ""
    },
    {
        ...
        "directJa": "あなたがタム神を行かせて、もう一度して、タム神が行っていない。",
    ...
    },
    {
        ...
        "directJa": "または、あの人(=相手)がタム神を行かせて、あなたがタム神を行かせる。",
    ...
    },
    {
        ...
        "directJa": "同じでない色の駒たちがない役はベポクを持つ。",
        "ja": "異なる色のない役は同色。",
        "en": ""
    },
    {
        ...
        "directJa": "王はベポクであるので5点を持つ。プラス 2",
    ...
    },
    {
        ...
        "directJa": "し始めるとき、駒たちがいる位置はこれと同一の位置である。",
    ...
    },
    {
        ...
        "directJa": "NI, TU, XJU, CAI, NAI, TJU, XU, CIのマス目はタンケ（タム神の場所）であって、ここでは駒が普通でない動きをする。",
    ...
    },
    {
        ...
        "directJa": "ZI, ZU, ZJU, ZAI, NO, TO, XO, COのマス目はタンナ（タム神の水）である。",
    ...
    },
    {
        ...
        "directJa": "あなたが駒をタンナに行かせたいならば、あなたは判定棒を投げ、3つのオモテか4つのオモテか5つのオモテを得なければならない。",
    ...
    },
    {
        ...
        "directJa": "例外的に、駒がタンナからタンナへ行くときは投げ棒を投げない。",
    ...
    },
    {
        ...
        "directJa": "そして、タンナにタム神または船が行くとき、判定棒を投げない。",
    ...
    },
    {
        ...
        "directJa": "ZOのマス目はタンツォ（タム神の山）であって、これはタンケでもありタンナでもある。",
    ...
    },
    {
        ...
        "directJa": "あなたの駒があの人(=相手)の駒のある場所に行って、あなたは相手の駒を取って、相手の駒はあなたのコプツォ（手札）へ行く。",
    ...
    },
    {
        ...
        "directJa": "どんなときも、あなたのコプツォにある駒は、駒のない場所へ行くことができる。",
    ...
    },
    {
        ...
        "directJa": "タンケでは駒は変わった動きをする。白いもの（=矢印や丸）がそれである。",
    ...
    },
    {
        ...
        "directJa": "タンケの(=にいる)【将】は近くの他の駒を守る。",
        "ja": "皇処の将は周りの駒を守る。",
        "en": ""
    },
    {
        ...
        "directJa": "近いというのは、将軍の場所のマスが接触している8箇所のことである。",
    ...
    },
    {
        ...
        "directJa": "CIのマス目にあるタンケの将軍はME, MI, MU, CE, CU, XE, XI, XUのマス目を守る。",
    ...
    },
    {
        ...
        "directJa": "車輪と馬とタンケの巫女は一つの駒がある場所に行き、さらに1つの移動をする事ができる。",
    ...
    },
    {
        ...
        "directJa": "人が行うことは以下のことから選んだ一つである。",
        "ja": "競技者は次のことをする。",
        "en": ""
    },
    {
    ...
    },
    {
        ...
        "directJa": "→：駒が移動するとき、できる移動は複数マスでもある。",
    ...
    },
    {
        ...
        "directJa": "タンケで（は踏越えの場所か来る場所までは変わった動きをしなければならない）",
    ...
    },
    {
        ...
        "directJa": "駒が行き、（行った先に）駒があれば、踏越えすることができる。",
    ...
    },
    {
        ...
        "directJa": "タンケで（は来る場所までは変わった動きをしなければならない。）",
        "ja": "皇処から (特殊な動きをしなければならない)",
        "en": ""
    },
    {
    ...
    },
    {
        ...
        "directJa": "移動が大きい数であるとき、あなたが踏越えをしたいなら、あなたは判定棒を投げ、あなたが動かせるのは判定棒の数より小さい数である。",
    ...
    },
    {
        ...
        "directJa": "この時、移動先に相手の駒があれば、相手の駒は自分の手駒に加わる。",
    ...
    },
    {
        "source": "アイル統一机戦書",
        "pmcp": "co celene e zo e tude jo tanna pi co doktit xiju pi delu letit 3leti o 4leti o 5leti.",
        "directJa": "あなたが駒をタンナに行かせたいならば、あなたは投げ棒を投げ、3つのオモテか4つのオモテか5つのオモテを得なければならない。",
    ...
    },
    {
        "source": "連盟員速習",
        "pmcp": "pulonleti julo nip cene tudeit nupanleti dec.",
        "directJa": "演じることは、異なる色に至らせることができない。",
    ...
    },
    {
        ...
        "directJa": "全てのもののごとく、机戦はかつては簡単であり、複雑化していった。",
    ...
    },
    {
        ...
        "directJa": "机戦はパイグの遊びであり、他の場所でも人々はこれをする。",
    ...
    },
    {
        ...
        "directJa": "ここで、この変な駒を使って「紙机戦」という。",
        "ja": "{⌛ここマジで解釈がわかりません}",
        "en": ""
    },
    {
    ...
    },
    {
        ...
        "directJa": "あなたの馬が PO-MO-LO-KO に行くと、馬が行って、あなたの馬は手駒に行かざるを得ない。",
    ...
    },
    {
        ...
        "directJa": "タンナではあなたの馬は手駒に行くとは限らず、いまあなたはタンケの馬を持っている。",
    ...
    },
    {
        ...
        "directJa": "このため、馬が移動する方法たちは、よくない方法である。",
    ...
    },
    {
        ...
        "directJa": "文化、それは一つの場所の心であり、そこにいる人たちの栄養である。",
    ...
    },
    {
        ...
        "directJa": "文化を知ってこそ、人々は人間をすることができる。",
    ...
    },
    {
        ...
        "directJa": "その文化を使って人と人は繋がり、より心の良いさまへ行くことができるのだ。",
    ...
    },
    {
        ...
        "directJa": "この番組で私たちは文化に隠れている歴史、昔の人が作った歴史を見る。さらに私たちは、今の人々の営みも見る。",
    ...
    },
    {
        ...
        "directJa": "これには文化があって、（これは）興奮する遊びです。",
    ...
    },
    {
        ...
        "directJa": "大きい時間(=長い時間)があってこそ、この時(=今)の机戦があります。",
    ...
    },
    {
        ...
        "directJa": "ここでは、考古学の行為(=実際の発掘調査)や考え(=考古学的見解)を思って(=考えに入れ)、番組の全てにおいて誇張はありません。こうやって私たちはこの大きな歴史を見せます。",
    ...
    },
    {
        ...
        "directJa": "ファイクレオネのどこから、いつ、机戦は来ました？",
    ...
    },
    {
        ...
        "directJa": "「クレオスが戦闘を話す道具をアレス・リンが見て、机で遊べる平和な遊びがアレス・リンの心に来た。これが机戦の始まることである。」",
    ...
    },
    {
        ...
        "directJa": "「スキュリオーティエにある宗教的儀式の方法は実は机戦のルールである」",
    ...
    },
    {
        ...
        "directJa": "「時間ある印刷工たちが活字を移動させ遊びとした」",
    ...
    },
    {
        ...
        "directJa": "しかしながら、これらは俗であり誤っています。専門家に訊いてみましょう。",
    ...
    },
    {
        ...
        "directJa": "イヌサリタ大学のターフ・シールジャーラフさんはこれを言います。",
    ...
    },
    {
        ...
        "directJa": "「えーとなに言えばいいかな。机戦を言う場所がスキュリオーティエ叙事詩にはないです。明確な証拠も地面から出て来ない。これがあって、えー、机戦は多分前半のアドルプドにはまだ存在しません。」",
    ...
    },
    {
        ...
        "directJa": "スキュリオーティエの詩は机戦より古いんです。これがあって、机戦はラートードから来る？またはエスタール？",
    ...
    },
    {
        ...
        "directJa": "「で、あなたたちは、『この時に机戦があったはずだ』ということを言いたいのでしょう。これも難しいです。一つ言うと、部屋のある石の大きい板、これは地面から出てきています。けれど、これを机戦に使っていたかどうか。それは私たちには分からないのです。」",
    ...
    },
    {
        ...
        "directJa": "タウポ自然科学大学のポー・フオックムットさんは木の板を取り出し、こう語ります。",
    ...
    },
    {
        ...
        "directJa": "「これを見てください。この木製の板はラートードの遺跡から来たものです。81個のマス目があって、大きさもよい。くぼみがあって、きっとここに駒を行かせて机戦を遊んだのでしょう。この理由により、私はあの時における机戦の存在を信じています。",
    ...
    },
    {
        ...
        "directJa": "たしかに、この板を見ると、私たちが知っている机戦が使うマス目に近いです。しかし一方でターフ・シールジャーラフさんはこれを否定します。",
    ...
    },
    {
        ...
        "directJa": "マス目の数は机戦っぽいですけど、この板の出身地から、もっと大きい板が来ているんですよ。これがあるので、人々は多分これを別のに使っていました。",
    ...
    },
    {
        ...
        "directJa": "ターフ・シールジャーラフさんは、「人々がマス目のある板を使って、たとえば戦争時に作戦を作っていたのでしょう」、と考えています。",
    ...
    },
    {
        ...
        "directJa": "そして、別の学者は「これは数を数える道具だ」や「文字を刻むときにこれを使う」と考えています。",
    ...
    },
    {
        ...
        "directJa": "しかし、そのときについては少数の記述と証拠しかありません。",
    ...
    },
    {
        ...
        "directJa": "「駒が行く本があってこそ、本当の証拠があるけど、大きい時間が行ってこそそれが私たちのもとに来る。(=時代が下らないとそれは出てきていない。)」",
    ...
    },
    {
        ...
        "directJa": "「机戦をとてもよく思うペッ・ネバイトさんがいて、彼と彼の部下の机戦を遊んだ記述が今まだあります。」",
    ...
    },
    {
        ...
        "directJa": "「しかし、真の証拠は真にこの時に始まる(=その時より前にはない)。これがあるし、我々は実際のことを知らないのだ。」",
    ...
    },
    {
        ...
        "directJa": "これがあっては私たちはまだ机戦が始まった時を知ることができないでしょう。",
    ...
    },
    {
        ...
        "directJa": "その驚く手がかりは、ターフ・イリーン・デクタフさんに隠れています。ああ、その手がかりとは何なのか。",
    ...
    },
    {
        ...
        "directJa": "いつ机戦は来ましたか？すべての人はこれを知りません。このため、私達はターフ・イリーン・デクタフ、イフトーンの大工を見ます。",
    ...
    },
    {
        ...
        "directJa": "ターフ・イリーン・デクタフと話した記録がラネーメ民族新聞の聞くメモにあります。",
    ...
    },
    {
        ...
        "directJa": "「そのとき私たちはポラカイカで川を移動させていて、途中で燐字の凹みのある小さな木が地面から来ました。」",
    ...
    },
    {
        ...
        "directJa": "「これを見て、これは机戦の駒であるはずだと私は思いました。そして机戦があの時代にありました。さらにクワ（の駒）がこの机戦にありました。私はこれに驚きました。」",
    ...
    },
    {
        ...
        "directJa": "古い時には、全ての駒は（それぞれ）異なった数を持っていました。役があったら、役の駒を見て、それたちの点数を足しました。",
    ...
    },
    {
        ...
        "directJa": "この古い数の数え方、今も（この）方法を使う老人が私たちにこれを話しました。",
    ...
    },
    {
        ...
        "directJa": "「近頃、足し算をするだけの簡単な計算法が流行っているけど、やっぱり一つ一つの駒の点数を無駄にしない机戦の方が正統だ。アイル統一机戦では、王虎馬と、王馬、王虎は異ならない点数を持つ。これは面白くない。」",
    ...
    },
    {
        ...
        "directJa": "この老人が言うことは、王は一つの点数、虎は0.6、馬は0.4、獣は2に増やす。点数を計算してみましょう。",
    ...
    },
    {
        ...
        "directJa": "たしかに、違う（という）ことを分かることができます。",
        "ja": "確かに違いが見られます。",
        "en": ""
    },
    {
        ...
        "directJa": "黒い虎・黒い兵・赤い船・黒い兵・赤い兵・黒い車・赤い虎・黒い馬",
    ...
    },
    {
        ...
        "directJa": "これがあったらどうなります？全ての駒の点数を足します。",
    ...
    },
    {
        ...
        "directJa": "0.6, 0.2, 0.1, 0.2, 0.2, 0.5, 0.6, 0.4, これらを足したら 2.8。",
    ...
    },
    {
        "source": "我々の文化3机戦の歴史",
        "pmcp": "jo kalzane {⌛} pi {⌛}. jo ail panit leti cepkulante, caupla-cucit-dodo at caupla-dodo at caupla-cucit letit nip waxecleti kin. ka nip e {⌛}",
        "directJa": "役において、必要な駒が少ない役、これを2倍して加え、必要な駒が多い役、これを4倍して加えます。",
    ...
    },
    {
        ...
        "directJa": "アイル統一机戦では、3, 2, 3, 2, 5, を足す、するとこれは 15。古い方法はつらいが簡単な方法とあまり異ならない。",
    ...
    },
    {
        ...
        "directJa": "レシェール・ヴェンタフは皆の知っているものである。人々はこう考えている。彼はリパラインの思想家であると。",
    ...
    },
    {
        ...
        "directJa": "それで、その論は皇論の子供で、これはリパラインの論において新しい皇論を話したものである。",
    ...
    },
    {
        ...
        "directJa": "これは一つの術の対策方法ではないが、一度良く行くと遊戯を一つのショトで終わらせることができる。",
    ...
    },
    {
        ...
        "directJa": "あなたが2つの将軍を繋がったタンケに行かせて、『タンケの上司』を互いに適用すると、隣接する全ての駒が相手による捕獲を受けないことができる",
    ...
    },
    {
        ...
        "directJa": "あなたは将をとることもできないので、相手が連将を作ると光がない。",
    ...
    },
    {
        ...
        "directJa": "これは古い戦術なのでこの戦術への対策はたくさんあり、一番速く連将を作ることは今は難しいが後半に連将を作るとこれはとても強い。",
    ...
    },
    {
        ...
        "directJa": "向こう側にある駒が取ることを受けやすく、これが弱い。",
        "ja": "反対側の駒が取られやすいのが弱点。",
        "en": ""
    },
    {
    ...
    },
    {
        ...
        "directJa": "人はこの戦術が連将を作ることに対するものだという。日(=手番)の値が少なく、これは多くの戦術に対するものかもしれない。",
    ...
    },
    {
        ...
        "directJa": "これがある時あなたは相手の将を取ることができる、本当に。",
    ...
    },
    {
        ...
        "directJa": "人はあなたは多くのときに使うことができ、これが侵攻にとても強いという。",
    ...
    },
    {
        ...
        "directJa": "しかし、巫の利益のために皇を使わねばならないので、相手が皇を行かせた時、この戦術の光が消え、これ(=このこと)が弱い。",
    ...
    },
    {
        ...
        "directJa": "また、あなたが前半人において激巫を行うとき相手は弓を使ってあなたの馬を取りやすい。なのでこの戦術は後半人にある。",
    ...
    },
    {
        ...
        "directJa": "これは最も速く相手の王を取ることを見る(=目指す)。これは発展しやすくないが、前半人と後半人の2つがこれを使うことができ相手はあなたの王を取りやすくなく、これが特徴である。",
    ...
    },
    {
        ...
        "directJa": "人は相手のこれへの対策は先に皇を来させることや王を動かすことや他の駒をZEに動かすことだと提案する。しかし、全てにおいて相手の他の駒の動きは遅くなる。",
    ...
    },
    {
        ...
        "directJa": "激巫と将皇将はお互いに皇を使いたがるため将皇将は激巫とはうまくいかない。",
    ...
    },
    {
        ...
        "directJa": "また、相手が皇を動かすとあなたの王は危険である。これは連将ではないので将は取られやすい。あなたはこれらを思う(=これらに注意する)必要がある。",
    ...
    },
    {
        ...
        "directJa": "この戦術の全てへの強みはこれである。裁の値が0の値でないならばあなたはこれを1日(=1手)で作れて、これが速い。",
    ...
    },
    {
        ...
        "directJa": "前半人と後半人の2つ(=両方)でこれはよく動き、これが強い。",
    ...
    },
    {
        ...
        "directJa": "これは強さと簡単さの2つ(=両方)を持つのでこれは全ての戦術においてよく使われる。",
    ...
    },
    {
        ...
        "directJa": "人はこれを定弓への対策として作った。そして人は普通これを後半人で使う。",
    ...
    },
    {
        ...
        "directJa": "定弓に本当にこれがある。巫が皇処に動くときに王か馬弓兵が必ず作られること。抗弓はこれを守ることができ、これが全てにおける良い特徴である。",
    ...
    },
    {
        ...
        "directJa": "最古の書が新しいのでこれへの対策はあまりないが、人は弓が効くことをを邪魔することや CAU の弓を取って馬弓兵を見ることを言う。",
    ...
    },
    {
        "source": "連盟サイト「初期配置」",
        "pmcp": "jo pac it leti nole zo cet mol polto e panleti jo ka.",
        "directJa": "始める時は、駒たちの場所はこれと同じである。",
        "ja": "下の図のように配置する。",
        "en": ""
    },
    {
        ...
        "directJa": "赤いマスはタンケであり、ここで駒は奇妙な動きをする",
    ...
    },
    {
        ...
        "directJa": "青いマスはタンナであり、あなたがここに駒を動かしたいならば、シユを投げて3以上の数を得る必要がある。",
    ...
    },
    {
        ...
        "directJa": "タンの色のマスはタンツォであり、タンケでもタンナでもある。",
    ...
    },
    {
        ...
        "directJa": "駒をタンナに行かせるなら投げ棒を投げて３以上",
    ...
    },
    {
        ...
        "directJa": "投げ棒の数以下が、あなたが駒を動かせる数です",
    ...
    },
    {
        ...
        "directJa": "日本の皆様、こんにちは。私はアイル共和国文化省広報処の事務長、イェーギン・ガートゥ・シャードザンマーである。",
    ...
    },
    {
        ...
        "directJa": "今私は日本机戦連盟から依頼を受けて「筆兵無傾 Advent Calendar」に言葉を書く。",
    ...
    },
    {
        ...
        "directJa": "私は連盟からこれが私たちの世界を取材する記事のイベントであると聞いている。",
    ...
    },
    {
        ...
        "directJa": "広報処にはアイルと我々の世界、その文化を日本に教えるという仕事があり、その長として私は全ての記事を書く人と記事を読む人にとても感謝する。",
    ...
    },
    {
        ...
        "directJa": "日本人がこちらの記事を書き、私はこのことに我々の日々の広報の成果を感じる。",
    ...
    },
    {
        ...
        "directJa": "次に私はこのイベントの形式を話す。これにおいて人は一日に一つの記事を公開する。これはある日に始まり聖人を祝う日に終わる。",
    ...
    },
    {
        ...
        "directJa": "我々の世界では子供が日に一つの祝いの品を近くの人からもらう行事が存在する。これはある日に始まり子供の誕生日に終わる。これは「マーサロ」であり、レアディオのある地域における子供の祝い方である。",
    ...
    },
    {
        ...
        "directJa": "ふたつの似ている文化が別の世界にあり、これらは別の場所に始まり別の道をたどっている。われわれはこれを見て世界が違っていても異ならない部分が我々とあなたたちにあるという学びを学ぶことができる。",
    ...
    },
    {
        ...
        "directJa": "我々とあなた方の文化は違っていて似ているが、ふたつの文化を知れば、我々とあなた方が見る世界はきっととてもよくなるだろう。",
    ...
    },
    {
        ...
        "directJa": "終わりに、私はこれを祈る。「筆兵無傾 Advent Calendar」がうまくいって我々とあなた方の交流が盛んになりますように。",
    ...
    },
    {
        ...
        "directJa": "親プレイヤーだけが、声のを見ます。子プレイヤーは、散布するのだけを見ます。",
    ...
    },
    {
        ...
        "directJa": "子プレイヤーはその声を聞いて、伴侶の札を取ります。",
    ...
    },
    {
        ...
        "directJa": "これは『行ってマナナ島の場所場所を見る』です。",
